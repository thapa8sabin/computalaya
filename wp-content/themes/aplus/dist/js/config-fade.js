...
//****** Set the launch day
      year =         '2014',                           // set the launch dates year
      month =        '12',                             // set the launch dates month
      day =          '01',                             // set the launch dates day
      hours =        '11',                             // set the launch dates hour
      minutes =      '31',                             // set the launch dates minute
      seconds =      '59',                             // set the launch dates second
      milliseconds = '59',
...
//****** Set the Google Map parameters
      city = new google.maps.LatLng(48.902643, 2.342405),       // set the map coordinates
      hall = new google.maps.LatLng(48.856936,2.352208),        // set the marker position
      mapZoom = 6,                                              // set the Google map zoom
      arrowColor = "#ffffff",                                   // set the arrow color
      arrowOpacity = 0,                                         // set the arrow opacity
      arrowStrokeOpacity = 1.0,                                 // set the arrow stroke opacity
      arrowStrokeWeight = 2.0,                                  // set the arrow stroke weight
      arrowScale = 8,                                           // set the arrow scale
      disableUI = true;                                         // set the default user interface 